...
<div id='section4' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
    ...
    <form action="{{ route('work.store') }}" method="POST">
        ...
        <div class="md:flex mb-6">
            ...
            <div class="md:w-2/3">
                <input class="form-input block w-full focus:bg-white" id="title" type="string" name="title" value="{{ old('title') }}">
        ...
        <div class="md:flex mb-6">
            ...
            <div class="md:w-2/3">
                <input class="form-input block w-full focus:bg-white" id="datum" type="string" name="datum" value="{{ old('datum') }}">
        ...
        <div class="md:flex mb-6">
            ...
            <div class="md:w-2/3">
                <input class="form-input block w-full focus:bg-white" id="chooseFile" type="file" placeholder="Choose file" name="file">

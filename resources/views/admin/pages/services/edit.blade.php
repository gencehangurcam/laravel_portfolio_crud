...
@section('content')
    <form {{ route('services.update', $service->id) }} method='POST' class="w-full max-w-sm">
        <div class="w-full min-h-screen bg-gray-50 flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            <div class="w-full sm:max-w-md p-5 mx-auto">
                <h2 class="mb-12 text-center text-5xl font-extrabold">Modifie your services.</h2>
                @csrf
                @method("PUT")
                <div class="mb-4">
                ...
                <div class="mb-4">
                    <label class="block mb-1" for="password">logo</label>
                    <input id="icone" type="string" name="icone"
                        class="py-2 px-3 border border-gray-300 focus:border-red-300 focus:outline-none focus:ring focus:ring-red-200 focus:ring-opacity-50 rounded-md shadow-sm disabled:bg-gray-100 mt-1 block w-full" />
                </div>
                <div class="mb-4">
                    <label class="block mb-1" for="password">description</label>
